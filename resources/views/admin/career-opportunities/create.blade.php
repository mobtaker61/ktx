        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create New Career Opportunity</h3>
                    <a href="{{ route('admin.career-opportunities.index') }}" class="btn btn-secondary float-end">
                        <i class="fas fa-arrow-left me-2"></i>Back to List
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.career-opportunities.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('experience_level') is-invalid @enderror"
                                        ...
                                        <option value="0-1" {{ old('experience_level') == '0-1' ? 'selected' : '' }}>0-1 years</option>
                                        <option value="1-3" {{ old('experience_level') == '1-3' ? 'selected' : '' }}>1-3 years</option>
                                        <option value="3-5" {{ old('experience_level') == '3-5' ? 'selected' : '' }}>3-5 years</option>
                                        <option value="5-8" {{ old('experience_level') == '5-8' ? 'selected' : '' }}>5-8 years</option>
                                        <option value="8-10" {{ old('experience_level') == '8-10' ? 'selected' : '' }}>8-10 years</option>
                                        <option value="10+" {{ old('experience_level') == '10+' ? 'selected' : '' }}>10+ years</option>
                                    </select>
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-primary btn-lg px-5">
                                <i class="fas fa-save me-2"></i>Create Opportunity
                            </button>
                        </div>
                    </form>
                </div>
