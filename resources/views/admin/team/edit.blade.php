...
@section('title', 'Edit Team Member - KTX Admin')
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('level') is-invalid @enderror"
                            ...
                            <option value="1" {{ old('level', $team->level) == '1' ? 'selected' : '' }}>Level 1 - Executive</option>
                            <option value="2" {{ old('level', $team->level) == '2' ? 'selected' : '' }}>Level 2 - Management</option>
                            <option value="3" {{ old('level', $team->level) == '3' ? 'selected' : '' }}>Level 3 - Senior Staff</option>
                            <option value="4" {{ old('level', $team->level) == '4' ? 'selected' : '' }}>Level 4 - Staff</option>
                        </select>
                        @error('level')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('order') is-invalid @enderror"
                               id="order" name="order" value="{{ old('order', $team->order) }}" min="0">
                        @error('order')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="url" class="form-control @error('linkedin_url') is-invalid @enderror"
                                   id="linkedin_url" name="linkedin_url" value="{{ old('linkedin_url', $team->linkedin_url) }}" placeholder="https://linkedin.com/in/username">
                            @error('linkedin_url')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-2">
                            ...
                            <input type="url" class="form-control @error('twitter_url') is-invalid @enderror"
                                   id="twitter_url" name="twitter_url" value="{{ old('twitter_url', $team->twitter_url) }}" placeholder="https://twitter.com/username">
                            @error('twitter_url')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-2">
                            ...
                            <input type="url" class="form-control @error('facebook_url') is-invalid @enderror"
                                   id="facebook_url" name="facebook_url" value="{{ old('facebook_url', $team->facebook_url) }}" placeholder="https://facebook.com/username">
                            @error('facebook_url')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
